...
<body class="flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center">Tambah Data</h2>

        <form action="../backend/tambah.php" method="POST" enctype="multipart/form-data" class="space-y-5">
            <div>
